"""
Upload plots directory to DigitalOcean Spaces
Uploads all visualization files (SVG, PNG, PDF) to cloud storage
"""
import os
import boto3
...
def upload_directory(local_dir, bucket_name, prefix=''):
    ...
    print(f"\n🌐 Your plots are now accessible at:")
    print(f"   {cdn_url}/plots/")
...
if __name__ == '__main__':
    ...
    print("="*60)
    print("DIGITALOCEAN SPACES UPLOAD - PLOTS")
    print("="*60)
    ...
    print("\n🚀 Starting upload...")
    print(f"   Scanning directory: plots/")
    
    # Upload plots data
    upload_directory('plots', SPACE_NAME, prefix='plots')
